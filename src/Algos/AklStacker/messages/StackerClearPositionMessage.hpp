...
struct StackerClearPositionMessage
{
	static constexpr MessageType type = MessageType::STACKER_CLEAR_POSITION;
	std::string id;
	...
	static StackerClearPositionMessage Deserialize(const rapidjson::Document &document)
	{
		StackerClearPositionMessage message;
	...
	static StackerClearPositionMessage DeserializeFromString(const std::string &json)
	{
		rapidjson::Document document;

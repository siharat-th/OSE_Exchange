...
// This macro should only be used inside non-static member functions,
// where 'this' is available.
#define __CLASS__ boost::typeindex::type_id_with_cvr<decltype(*this)>().pretty_name()

/// For static functions, supply the class type explicitly:
#define __CLASS_STATIC__(T) boost::typeindex::type_id_with_cvr<T>().pretty_name()

/** Notes on usage of __CLASS__ 
 * 
 * 
 * static:
 * class MyClass {
      public:
          static void logError() {
              KT01_LOG_CRITICAL(__CLASS_STATIC__(MyClass), "NO SECDEF DIRECTORY IN SETTINGS!!! FATAL!");
          }
      };
 * 
 * non-static:
 * KT01_LOG_CRITICAL(__CLASS__, "NO SECDEF DIRECTORY IN SETTINGS!!! FATAL!");
 * 
*/
...
#       define KT01_API __attribute__((visibility("default")))
#   else
#       define KT01_API
#   endif
#endif
